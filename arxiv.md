...
* **Status:** Partial (8.12(c)(vi)(1)–(5) all `Pass` — (5) itself split into (a)–(d), all `Pass`, with (c) further split into (1)–(4), all `Pass`; 8.12(c)(vi)(6) merged into (5); 8.12(c)(vi)(7) remains `Deferred` — see sub-rows)
