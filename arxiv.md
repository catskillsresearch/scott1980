...
(inventory rows **7.22a–h** and **7.22i(a)**, all **Pass**); what remains (**7.22i(b)–l**) is **integration** into
...
delivered **7.22a–h** and **7.22i(a)**; **C9b–C10** and optional **C7b** remain for **7.22i(b)–k**.
...
* [Exercise722Presentation.lean](https://github.com/catskillsresearch/scott1980/blob/main/Scott1980/Neighborhood/Exercise722Presentation.lean) — `SsysX` enumeration, `ssysConsChar`, C9 `RecDecidable₂` bridge (partial; **`Ssys_cons_computable`** open — **7.22i(b)**)
...
* **Appendix A** — Exercise 7.22 Composer autorun (**7.22a–h**, **7.22i(a)** Pass; **7.22i(b)–l** open; C9a–C9b split)
