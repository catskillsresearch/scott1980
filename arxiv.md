...
### 1.1 Methodology — a *biblical*, line-by-line Goal List
...
### 1.2 Lecture I (§1) Goal List — complete inventory (all of Lecture I, through Exercise 1.27)
...
### 1.2.II Lecture II (§2) Goal List — approximable mappings (complete inventory)

**Lean target:** `Scott1980/Neighborhood/Approximable.lean` (Def 2.1, Prop 2.2, Thm 2.5, Prop 2.6,
...
### 1.2.III Lecture III (§3) Goal List — domain constructs (complete inventory)

**Lean target:** `Scott1980/Neighborhood/Product.lean` (§3.1–3.7) and
`Scott1980/Neighborhood/FunctionSpace.lean` (§3.8–3.13) — **live**. The product and function-space
...
### 1.2.IV Lecture IV — *Fixed points and recursion* (Theorems 4.1, 4.2; Examples 4.3, 4.4; Definition 4.5 + Theorem 4.6; **all Exercises 4.7–4.25** formalized)
...
### 1.2.V Lecture V — *Typed λ-calculus* (core + Exercises 5.7–5.16 formalized — **Lecture V exercises complete**)
...
### 1.2.VI Lecture VI — *Introduction to domain equations* (Examples 6.1, 6.2 + categorical spine 6.3–6.7 and Definition 6.8 **Pass**; rest transcribed)
...
### 1.2.VII Lecture VII — *Computability in effectively given domains* (transcribed; formalization deferred)
...
### 1.2.VIII Lecture VIII — *Retracts of the universal domain* (transcribed; formalization deferred)
...
### 1.3 §1 dependency (parsed so far)
...
#### Example 1.2 — `Scott1980/Neighborhood/Example12.lean`
...
#### Example 1.3 — `Scott1980/Neighborhood/Example13.lean`
...
#### Example 1.4 — `Scott1980/Neighborhood/Example14.lean`
...
#### Example 1.5 / Factoid 1.5a — `Scott1980/Neighborhood/Example15.lean`
