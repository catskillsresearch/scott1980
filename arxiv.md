...
* **Status:** Partial — re-scoped into 4 sub-parts below; `(d)(4)(a)` is `Pass`, `(d)(4)(b)`–`(d)` remain `Deferred`
...
* **Status:** Pass (conditional correctness only — the unconditional "found at `N=4ⁿ`" gap is flagged and deferred, see Proof Notes)
