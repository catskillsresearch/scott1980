...
(inventory rows **7.22a–h**, **7.22i(a)**, **7.22i(b)1–8**, **7.22j**, and **7.22k**, all **Pass**);
what remains (optional **7.22l**) is a further extension, plus (also optional) upgrading the
`ConsistencyPresentation` already proved to a full `ComputablePresentation` via `inter`/
`inter_primrec`/`inter_spec`/`masterIdx`. We mechanize Scott's least positive neighbourhood system generated by
...
and **7.22k**; only the **optional** **7.22l** remains.
...
* **Appendix A** — Exercise 7.22 Composer autorun (**7.22a–h**, **7.22i(a)**, **7.22i(b)1–8**, **7.22j**, **7.22k** Pass; optional **7.22l** open; C9b slice tracker)
