...
* **Status:** Partial — `(d)(5)(d)(i)`–`(iii)` (`toD1Code`'s `up_mem` helper, full assembly, and `toD0Code`'s `up_mem` helper) are `Pass`; `(d)(5)(d)(iv)` (`toD0Code`, full assembly) remains not started
