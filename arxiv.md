...
* **Status:** Partial (8.12(c)(vi)(1) — the abstract `Yseq` closed-form apparatus — is `Pass`; 8.12(c)(vi)(2)–(7) remain `Deferred`, none yet started — see sub-rows)
