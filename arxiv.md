...
* **Status:** Partial — 8.12(d)(1)–(2) are `Pass`; (d)(3) has been re-scoped into 6 sub-parts (`(d)(3)(a)–(f)`, see below), of which **(a)–(e) are now `Pass`**; (d)(3)(f) and (d)(4)–(6) remain `Deferred`
