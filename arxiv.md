...
* **Status:** Pass (all 8 parts Pass — (i)–(viii), with (vii) itself split into 4 sub-parts (vii)(1)–(4), all Pass; see sub-rows and `HANDOFF.md` for the full breakdown)
...
* **Status:** Partial (5 of 6 parts Pass — see sub-rows; (vi) Deferred)
